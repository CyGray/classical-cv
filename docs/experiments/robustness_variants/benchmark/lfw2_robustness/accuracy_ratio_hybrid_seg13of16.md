...
| **Overall AR** | **86.79%** | **98.11%** | **94.40%** | **98.15%** |
| Pooled AR [95% CI] | 85.14% [84.55-85.70] | 97.86% [97.61-98.08] | 93.68% [93.27-94.06] | 97.91% [97.66-98.13] |
| Mean latency | 94.78 ms | 20.16 ms | 3.47 ms | 7.27 ms |
| Latency median / p95 | 93.13 / 112.44 ms | 19.74 / 25.41 ms | 0.48 / 9.14 ms | 7.16 / 9.77 ms |

## Per modification

| Modification | cv_only | dl_only | cascade | parallel | winner | escalation |
|---|---:|---:|---:|---:|---|---:|
| brightness_up | 97.6% | 99.6% | 99.8% | 99.7% | dl_stronger | 51% |
| brightness_down | 72.2% | 99.0% | 96.7% | 99.0% | dl_stronger | 46% |
| contrast_up | 78.9% | 99.4% | 92.0% | 99.4% | dl_stronger | 26% |
| contrast_down | 100.0% | 99.7% | 99.7% | 99.7% | tie | 61% |
| gamma_up | 100.0% | 99.7% | 99.9% | 99.7% | tie | 31% |
| gamma_down | 97.5% | 99.4% | 100.0% | 99.4% | tie | 40% |
| gaussian_noise | 28.9% | 82.5% | 64.7% | 82.5% | dl_stronger | 59% |
| gaussian_blur | 100.0% | 99.6% | 99.7% | 99.6% | tie | 58% |
| motion_blur | 98.9% | 99.4% | 99.2% | 99.5% | tie | 48% |
| rotation | 67.8% | 99.7% | 81.6% | 99.7% | dl_stronger | 43% |
| zoom | 99.7% | 99.5% | 99.6% | 99.7% | tie | 32% |
| occlusion | 100.0% | 99.6% | 100.0% | 99.7% | tie | 24% |
...
- Cascade vs parallel (run-both ceiling): -3.75 pts overall, within tolerance on 8 / 12 modifications
...
- Modified probes: 14760 | w/x/y/z = 12508/58/1936/258
- **Recovery rate** = 88.2% [86.8-89.5] (1936/2194)
- **Both-fail ceiling** = 1.7% [1.5-2.0]
- **McNemar** (x=58 vs y=1936): p_exact = 0.0e+00, chi2_cc = 1766.9
...
- Deployed gate vs 'LBPH wrong': escalates 6440 probes; TPR (wrong probes escalated) = 0.682, FPR (right probes escalated) = 0.393, precision = 0.232
- Escalation reasons on rescued-eligible (LBPH-wrong) probes: quality=746, low_margin=744, ambiguous_band=7
- Including clean probes: AUC(d1) = 0.995, gate TPR = 0.682, FPR = 0.388
