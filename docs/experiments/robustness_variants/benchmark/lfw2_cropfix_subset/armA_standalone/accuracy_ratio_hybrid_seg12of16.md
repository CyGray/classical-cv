...
| **Overall AR (41 mods, TPIR @ threshold)** | **0.00%** | **83.40%** |
| Pooled AR [95% CI] | 0.00% [0.00-0.36] | 83.40% [81.04-85.51] |
| Overall Rank-1 (41 mods, threshold-free) | 0.28% | 88.84% |
| Pooled Rank-1 [95% CI] | 0.28% [0.10-0.82] | 88.84% [86.81-90.59] |
| Mean latency | 88.10 ms | 33.28 ms |
| Latency median / p95 | 87.13 / 127.06 ms | 32.37 / 44.89 ms |
...
| persp_6 | 0.0% | 92.3% | n/a / 0.96 | dl_stronger |
| persp_4 | 0.0% | 92.3% | n/a / 0.96 | dl_stronger |
...
- Modified probes: 1066 | w/x/y/z = 0/0/889/177
- **Recovery rate** = 83.4% [81.0-85.5] (889/1066)
- **Both-fail ceiling** = 16.6% [14.5-19.0]
- **McNemar** (x=0 vs y=889): p_exact = 4.8e-268, chi2_cc = 887.0
