...
| **Overall AR (41 mods, TPIR @ threshold)** | **75.80%** |
| Pooled AR [95% CI] | 75.80% [73.14-78.27] |
| Overall Rank-1 (41 mods, threshold-free) | 83.77% |
| Pooled Rank-1 [95% CI] | 83.77% [81.44-85.86] |
| Mean latency | 175.66 ms |
| Latency median / p95 | 174.97 / 228.39 ms |
