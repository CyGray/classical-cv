...
| **Overall AR (41 mods, TPIR @ threshold)** | **81.05%** |
| Pooled AR [95% CI] | 81.05% [78.59-83.29] |
| Overall Rank-1 (41 mods, threshold-free) | 88.93% |
| Pooled Rank-1 [95% CI] | 88.93% [86.91-90.68] |
| Mean latency | 176.52 ms |
| Latency median / p95 | 175.18 / 228.26 ms |
