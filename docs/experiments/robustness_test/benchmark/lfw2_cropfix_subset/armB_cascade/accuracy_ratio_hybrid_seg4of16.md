...
| **Overall AR (41 mods, TPIR @ threshold)** | **81.24%** |
| Pooled AR [95% CI] | 81.24% [78.78-83.47] |
| Overall Rank-1 (41 mods, threshold-free) | 89.87% |
| Pooled Rank-1 [95% CI] | 89.87% [87.91-91.54] |
| Mean latency | 175.82 ms |
| Latency median / p95 | 173.62 / 224.25 ms |
...
| Detector-canonical Rank-1 (threshold-free) | **25.96%** |
