...
| **Overall AR** | **86.84%** | **98.18%** | **94.86%** | **98.23%** |
| Pooled AR [95% CI] | 85.21% [84.63-85.77] | 97.95% [97.71-98.17] | 94.16% [93.77-94.53] | 98.01% [97.77-98.22] |
| Mean latency | 93.95 ms | 19.74 ms | 3.61 ms | 7.09 ms |
| Latency median / p95 | 92.43 / 110.70 ms | 19.41 / 24.48 ms | 0.56 / 8.82 ms | 7.02 / 9.39 ms |

## Per modification

| Modification | cv_only | dl_only | cascade | parallel | winner | escalation |
|---|---:|---:|---:|---:|---|---:|
| brightness_up | 95.2% | 99.4% | 99.7% | 99.6% | dl_stronger | 56% |
| brightness_down | 75.1% | 99.4% | 96.8% | 99.6% | dl_stronger | 44% |
| contrast_up | 78.6% | 99.7% | 94.0% | 99.7% | dl_stronger | 32% |
| contrast_down | 100.0% | 99.4% | 99.7% | 99.4% | tie | 64% |
| gamma_up | 100.0% | 99.7% | 100.0% | 99.7% | tie | 37% |
| gamma_down | 97.5% | 99.4% | 99.9% | 99.5% | tie | 39% |
| gaussian_noise | 27.9% | 83.5% | 66.6% | 83.6% | dl_stronger | 63% |
| gaussian_blur | 100.0% | 99.4% | 99.7% | 99.4% | tie | 62% |
| motion_blur | 98.7% | 99.4% | 99.5% | 99.4% | tie | 54% |
| rotation | 69.1% | 99.7% | 82.4% | 99.7% | dl_stronger | 46% |
| zoom | 99.9% | 99.5% | 99.9% | 99.6% | tie | 37% |
| occlusion | 100.0% | 99.5% | 100.0% | 99.5% | tie | 28% |
...
- Cascade vs parallel (run-both ceiling): -3.37 pts overall, within tolerance on 8 / 12 modifications
...
- Modified probes: 14760 | w/x/y/z = 12506/71/1952/231
- **Recovery rate** = 89.4% [88.1-90.6] (1952/2183)
- **Both-fail ceiling** = 1.6% [1.4-1.8]
- **McNemar** (x=71 vs y=1952): p_exact = 0.0e+00, chi2_cc = 1747.1
...
| gaussian_noise | 1038 | 808 | 78% | 16.0% | 4.3e-229 | 1.00 |
...
- Deployed gate vs 'LBPH wrong': escalates 6933 probes; TPR (wrong probes escalated) = 0.707, FPR (right probes escalated) = 0.429, precision = 0.223
- Escalation reasons on rescued-eligible (LBPH-wrong) probes: quality=858, low_margin=677, ambiguous_band=8
- Including clean probes: AUC(d1) = 0.994, gate TPR = 0.707, FPR = 0.424
