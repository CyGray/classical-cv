...
| **Overall AR** | **85.80%** | **98.26%** | **94.66%** | **98.27%** |
| Pooled AR [95% CI] | 84.15% [83.55-84.73] | 98.01% [97.77-98.22] | 93.97% [93.57-94.34] | 98.02% [97.78-98.23] |
| Mean latency | 94.75 ms | 20.05 ms | 3.79 ms | 7.26 ms |
| Latency median / p95 | 93.19 / 112.24 ms | 19.62 / 25.25 ms | 0.58 / 9.17 ms | 7.15 / 9.80 ms |

## Per modification

| Modification | cv_only | dl_only | cascade | parallel | winner | escalation |
|---|---:|---:|---:|---:|---|---:|
| brightness_up | 96.6% | 99.7% | 99.9% | 99.7% | dl_stronger | 54% |
| brightness_down | 70.8% | 99.6% | 97.1% | 99.6% | dl_stronger | 48% |
| contrast_up | 73.7% | 99.7% | 92.5% | 99.7% | dl_stronger | 34% |
| contrast_down | 100.0% | 99.7% | 99.7% | 99.7% | tie | 64% |
| gamma_up | 100.0% | 99.7% | 100.0% | 99.7% | tie | 38% |
| gamma_down | 95.6% | 99.7% | 99.6% | 99.7% | dl_stronger | 42% |
| gaussian_noise | 27.0% | 82.4% | 65.8% | 82.4% | dl_stronger | 63% |
| gaussian_blur | 100.0% | 99.7% | 99.7% | 99.7% | tie | 64% |
| motion_blur | 98.9% | 99.7% | 99.4% | 99.7% | tie | 55% |
| rotation | 67.4% | 99.7% | 82.6% | 99.7% | dl_stronger | 48% |
| zoom | 99.5% | 99.7% | 99.7% | 99.7% | tie | 38% |
| occlusion | 100.0% | 99.7% | 99.8% | 99.7% | tie | 29% |
...
- Modified probes: 14760 | w/x/y/z = 12382/38/2084/256
- **Recovery rate** = 89.1% [87.7-90.3] (2084/2340)
- **Both-fail ceiling** = 1.7% [1.5-2.0]
- **McNemar** (x=38 vs y=2084): p_exact = 0.0e+00, chi2_cc = 1970.8
...
| gaussian_noise | 1051 | 802 | 76% | 17.3% | 6.6e-231 | 1.00 |
...
- Deployed gate vs 'LBPH wrong': escalates 7127 probes; TPR (wrong probes escalated) = 0.725, FPR (right probes escalated) = 0.437, precision = 0.238
- Escalation reasons on rescued-eligible (LBPH-wrong) probes: quality=962, low_margin=725, ambiguous_band=9
- Including clean probes: AUC(d1) = 0.986, gate TPR = 0.725, FPR = 0.432
