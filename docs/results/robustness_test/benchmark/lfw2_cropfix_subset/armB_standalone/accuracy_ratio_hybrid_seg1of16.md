...
| **Overall AR (41 mods, TPIR @ threshold)** | **0.09%** | **84.52%** |
| Pooled AR [95% CI] | 0.09% [0.02-0.53] | 84.52% [82.23-86.57] |
| Overall Rank-1 (41 mods, threshold-free) | 2.44% | 87.05% |
| Pooled Rank-1 [95% CI] | 2.44% [1.67-3.55] | 87.05% [84.91-88.94] |
| Mean latency | 106.29 ms | 64.66 ms |
| Latency median / p95 | 106.04 / 140.27 ms | 63.20 / 89.46 ms |
...
| rot_10 | 3.8% | 96.2% | n/a / 1.00 | dl_stronger |
...
- Modified probes: 1066 | w/x/y/z = 1/0/900/165
- **Recovery rate** = 84.5% [82.2-86.6] (900/1065)
- **Both-fail ceiling** = 15.5% [13.4-17.8]
- **McNemar** (x=0 vs y=900): p_exact = 2.4e-271, chi2_cc = 898.0
...
| rot_10 | 25 | 24 | 96% | 3.8% | 1.2e-07 | 1.00 |
