...
| **Overall AR (41 mods, TPIR @ threshold)** | **0.09%** | **81.61%** |
| Pooled AR [95% CI] | 0.09% [0.02-0.53] | 81.61% [79.18-83.82] |
| Overall Rank-1 (41 mods, threshold-free) | 2.25% | 88.93% |
| Pooled Rank-1 [95% CI] | 2.25% [1.52-3.33] | 88.93% [86.91-90.68] |
| Mean latency | 106.42 ms | 63.78 ms |
| Latency median / p95 | 104.66 / 141.88 ms | 62.74 / 89.46 ms |
...
| rot_10 | 3.8% | 92.3% | n/a / 1.00 | dl_stronger |
...
- Modified probes: 1066 | w/x/y/z = 1/0/869/196
- **Recovery rate** = 81.6% [79.2-83.8] (869/1065)
- **Both-fail ceiling** = 18.4% [16.2-20.8]
- **McNemar** (x=0 vs y=869): p_exact = 5.1e-262, chi2_cc = 867.0
