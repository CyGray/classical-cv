...
|---|---:|---:|
| Clean held-out baseline - Rank-1 (threshold-free) | 0.00% | 96.00% |
| Clean held-out baseline - TPIR @ threshold | 0.00% | 92.00% |
| **Overall AR (41 mods, TPIR @ threshold)** | **0.00%** | **80.00%** |
| Pooled AR [95% CI] | 0.00% [0.00-0.37] | 80.00% [77.44-82.33] |
| Overall Rank-1 (41 mods, threshold-free) | 0.20% | 86.15% |
| Pooled Rank-1 [95% CI] | 0.20% [0.05-0.71] | 86.15% [83.90-88.13] |
| Mean latency | 86.89 ms | 34.15 ms |
| Latency median / p95 | 86.54 / 125.33 ms | 33.12 / 45.06 ms |
...
| persp_10 | 0.0% | 88.0% | n/a / 0.96 | dl_stronger |
...
| brightness_p20 | 0.0% | 96.0% |
| brightness_p10 | 0.0% | 96.0% |
...
- Modified probes: 1025 | w/x/y/z = 0/0/820/205
- **Recovery rate** = 80.0% [77.4-82.3] (820/1025)
- **Both-fail ceiling** = 20.0% [17.7-22.6]
- **McNemar** (x=0 vs y=820): p_exact = 2.9e-247, chi2_cc = 818.0
...
| persp_10 | 25 | 22 | 88% | 12.0% | 4.8e-07 | n/a |
