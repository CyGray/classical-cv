...
| **Overall AR (41 mods, TPIR @ threshold)** | **0.00%** | **81.05%** |
| Pooled AR [95% CI] | 0.00% [0.00-0.36] | 81.05% [78.59-83.29] |
| Overall Rank-1 (41 mods, threshold-free) | 0.66% | 89.87% |
| Pooled Rank-1 [95% CI] | 0.66% [0.32-1.35] | 89.87% [87.91-91.54] |
| Mean latency | 110.85 ms | 68.45 ms |
| Latency median / p95 | 111.95 / 152.45 ms | 63.53 / 116.05 ms |
...
| Detector-canonical Rank-1 (threshold-free) | **0.96%** | **25.96%** |
...
- Modified probes: 1066 | w/x/y/z = 0/0/864/202
- **Recovery rate** = 81.1% [78.6-83.3] (864/1066)
- **Both-fail ceiling** = 18.9% [16.7-21.4]
- **McNemar** (x=0 vs y=864): p_exact = 1.6e-260, chi2_cc = 862.0
