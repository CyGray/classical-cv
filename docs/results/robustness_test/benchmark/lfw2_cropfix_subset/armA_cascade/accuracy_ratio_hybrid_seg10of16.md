...
| **Overall AR (41 mods, TPIR @ threshold)** | **77.39%** |
| Pooled AR [95% CI] | 77.39% [74.79-79.80] |
| Overall Rank-1 (41 mods, threshold-free) | 85.46% |
| Pooled Rank-1 [95% CI] | 85.46% [83.22-87.45] |
| Mean latency | 176.45 ms |
| Latency median / p95 | 174.42 / 224.70 ms |
