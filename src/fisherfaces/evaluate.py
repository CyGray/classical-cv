"""Thin Fisherfaces evaluation wrapper over the shared classical pipeline.
...
exact open-set loop used by LBPH and Eigenfaces.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate a Fisherfaces model on the clean held-out La Salle test split by default."
    )
    add_dataset_args(
        parser,
