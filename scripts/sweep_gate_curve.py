...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--margins", default=DEFAULT_MARGINS,
                        help="Comma list of margin_min values to sweep.")
    parser.add_argument("--tau-shifts", default=DEFAULT_SHIFTS,
                        help="Comma list of shifts applied to BOTH tau_accept and tau_reject.")
    parser.add_argument("--output-json", default="reports/benchmark/gate_operating_curve.json")
...
def collect_probe_records(args) -> list[dict]:
    ...
    def score(gray: np.ndarray, person: str, mod: str, level) -> None:
        ...
        records.append({
            ...
            "sface_name": sm.name, "quality": quality,
