...
Usage:
    python scripts/plot_independence_comparisons.py outputs/lbph/independence_test/comparisons.csv
    python scripts/plot_independence_comparisons.py results.json --column raw_distance --label "LBPH - LFW1"
    python scripts/plot_independence_comparisons.py comparisons.csv --threshold 12.5 --output-dir reports/adhoc
"""
