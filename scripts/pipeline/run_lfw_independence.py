...
threshold deliverable (La Salle DB1 = ``scripts/pipeline/run_independence_thresholds.py``).
...
Usage::
    ...
    python scripts/pipeline/run_lfw_independence.py --max-identities 300          # smoke
    python scripts/pipeline/run_lfw_independence.py --families eigenfaces --confirm-full
    python scripts/pipeline/run_lfw_independence.py --confirm-full                # full spec run
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-json", default="outputs/benchmark/independence_thresholds_lfw.json")
...
def run_family(family: str, args: argparse.Namespace, probes, face_cascade) -> dict | None:
    ...
    out_dir = _abs(f"outputs/independence/{family}_lfw")
