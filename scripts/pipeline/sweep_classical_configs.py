...
Usage::
    ...
    python scripts/pipeline/sweep_classical_configs.py
    python scripts/pipeline/sweep_classical_configs.py --families eigenfaces --impostor-max 400
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-json", default="outputs/benchmark/classical_config_sweep.json")
