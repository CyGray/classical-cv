...
Usage::
    ...
    python scripts/pipeline/compare_variants.py                       # full impostor set
    python scripts/pipeline/compare_variants.py --impostor-max-identities 400   # quick
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-json", default="outputs/benchmark/variant_comparison.json")
