...
Usage:
    python scripts/build_independence_rerun_comparison.py
"""
...
MODELS = [
    (
        "lbph", "LBPH",
        "reports/independence/hybrid/lsdb1_fixed",
        "mean_lbph_distance",
        "#2a78d6",
    ...
    (
        ...
        "reports/independence/eigenfaces_lasalle_native",
        "raw_distance",
        "#008300",
    ...
    (
        ...
        "reports/independence/fisherfaces_lasalle_native",
        "raw_distance",
        "#eda100",
