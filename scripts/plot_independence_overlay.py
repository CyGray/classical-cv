...
Usage:
    ...
    python scripts/plot_independence_overlay.py --preset lbph-datasets
    python scripts/plot_independence_overlay.py --preset sface-datasets

    # Or build your own set of series:
    python scripts/plot_independence_overlay.py --engine lbph --mode density \\
...
PRESETS: dict[str, dict] = {
    "lbph-datasets": {
        ...
        "mode": "density",
        "series": {
            "LSDB1": "reports/independence/lbph_latest/lsdb1_comparisons.csv",
            "LSDB2 (light)": "reports/independence/lbph_latest/lsdb2_light_comparisons.csv",
            "LFW1": "reports/independence/lbph_latest/lfw1_summary.json",
            "LFW2 (light)": "reports/independence/lbph_latest/summary.json",
        },
