...
| `outputs/independence/lbph_lfw1/native_predict_scale_yunet_smoke.json` | 2026-08-01 | LBPH YuNet LFW1 | Diagnostic smoke-run JSON (20 identities). Canonical sweep stored in `reports/independence/lbph_lfw1/native_predict_scale_yunet.json`. |
...
- **Deployed Threshold Source of Truth**: [`classical-cv/src/hybrid/thresholds.json`](file:///C:/Users/acer/Downloads/USLS%204th%20Year/Computer%20Vision/classical-cv/src/hybrid/thresholds.json)
- **Independence Master Audit**: [`docs/independence/MASTER_FILE.md`](file:///C:/Users/acer/Downloads/USLS%204th%20Year/Computer%20Vision/docs/independence/MASTER_FILE.md)
- **2026-08-02 Audit Trail**: [`classical-cv/docs/audits/STATE-08-02.md`](file:///C:/Users/acer/Downloads/USLS%204th%20Year/Computer%20Vision/classical-cv/docs/audits/STATE-08-02.md)
- **Pairwise Verification Results**: [`docs/experiments/pairwise-verification/lfw-results/`](file:///C:/Users/acer/Downloads/USLS%204th%20Year/Computer%20Vision/docs/experiments/pairwise-verification/lfw-results/)
